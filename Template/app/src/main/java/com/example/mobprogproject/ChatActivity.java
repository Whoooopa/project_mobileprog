...
import com.example.mobprogproject.adapter.ChatRecyclerAdapter;
import com.example.mobprogproject.adapter.SearchUserRecyclerAdapter;
import com.example.mobprogproject.model.ChatMessageModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    void callAPI(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization", "Bearer AAAAc9n6Va8:APA91bHmQvA_fsCgwyx4igHRuMHa1JF5hWXQjaU7hsjebp-H6twetlfwCIu7cgFKkEEBSM-WC5lMfItUHzVVYEyMMkE7SyPppwSZDNGdyOZcjzTXHbQUYFCbiJfYSYaazns57Z0DhZek")
                .build();
